...
import playlists from "../../public/better-playlists.png";
import celebchat from "../../public/celebchat.png";
import harmoni from "../../public/harmoni.png";
import cinezone from "../../public/cinezone.png";
      ...
      <div className="project-text mt-4">
        <div className="project-title flex items-center justify-between gap-5">
          ...
          <div className="project-icons flex gap-2 items-center">
            <a
              href="https://github.com/Sezergumus/collect"
              target="_blank"
              className="github h-fit"
            >
              <svg
                width="28"
                height="28"
        ...
        <div className="project-stack mt-4">
          <p className="text-white text-[18px] text-yellow font-medium">
            HTML - CSS - JavaScript - GSAP
          </p>
        </div>
        <div className="project-desc mt-4">
          <p className="text-white text-[18px] font-extralight">
            A promotion site for a lighting series called Collect with this site
            I learnt how to use animations.
          </p>
        </div>
      </div>
    </div>,
    <div className="project-item" key="yanindayim">
      ...
      <div className="project-text mt-4">
        <div className="project-title flex items-center justify-between gap-5">
          ...
          <div className="project-icons flex gap-2 items-center">
            <a
              href="https://github.com/sezergumus/yanindayim"
              target="_blank"
              className="github h-fit"
            >
              <svg
        ...
        <div className="project-stack mt-4">
          <p className="text-white text-[18px] text-yellow font-medium">
            React - MaterialUI - Vite
          </p>
        </div>
        <div className="project-desc mt-4">
          <p className="text-white text-[18px] font-extralight">
            A social responsibility project for earthquake in Türkiye with this
            site I learnt DB Management & Authorization.
          </p>
        </div>
      </div>
    </div>,
    <div className="project-item" key="cinezone">
      <div className="project-item-image-container">
        <div className="project-item-image">
          <Image src={cinezone} alt="Cinezone" />
        </div>
      </div>
      <div className="project-text mt-4">
        <div className="project-title flex items-center justify-between gap-5">
          <h1 className="text-[24px] text-white font-bold whitespace-nowrap">
            Cinezone
          </h1>
          <div className="project-line"></div>
          <div className="project-icons flex gap-2 items-center">
            <a
              href="https://github.com/Sezergumus/cinezone"
              target="_blank"
              className="github h-fit"
            >
              <svg
            ...
            <a
              href="https://cinezone.sezergumus.dev/"
              target="_blank"
              className="live-project w-fit h-fit"
            >
              <svg
        ...
        <div className="project-desc mt-4">
          <p className="text-white text-[18px] font-extralight">
            A theatre booking app with this app I learnt more about Next.js and
            Next.js API routes.
          </p>
        </div>
      </div>
    ...
    <div className="project-item" key="harmoni">
      ...
      <div className="project-text mt-4">
        <div className="project-title flex items-center justify-between gap-5">
          ...
          <div className="project-icons flex gap-2 items-center">
            <a
              href="https://github.com/Sezergumus/harmoni-ecommerce"
              target="_blank"
              className="github w-fit h-fit"
            >
              <svg
                width="28"
                height="28"
            ...
            <a
              href="https://harmoni.sezergumus.dev/"
              target="_blank"
              className="live-project w-fit h-fit"
            >
              <svg
        ...
        <div className="project-desc mt-4">
          <p className="text-white text-[18px] font-extralight">
            An e-commerce site for a made-up brand with this site I learnt more
            about grids and cart.
          </p>
        </div>
      </div>
    </div>,
    <div className="project-item" key="playlists">
      <div className="project-item-image-container">
        <div className="project-item-image">
          <Image src={playlists} alt="Better Playlists" />
        </div>
      </div>
      <div className="project-text mt-4">
        <div className="project-title flex items-center justify-between gap-5">
          ...
          <div className="project-icons flex gap-2 items-center">
            <a
              href="https://github.com/sezergumus/better-playlists"
              target="_blank"
              className="github h-fit"
            >
              <svg
            ...
            <a
              href="https://betterplaylists.sezergumus.dev/"
              target="_blank"
              className="live-project w-fit h-fit"
            >
              <svg
        ...
        <div className="project-stack mt-4">
          <p className="text-white text-[18px] text-yellow font-medium">
            React - Tailwind - Spotify API
          </p>
        </div>
        <div className="project-desc mt-4">
          <p className="text-white text-[18px] font-extralight">
            An app that gives you personalized recommendations and helps you
    ...
    <div className="project-item" key="celebchat">
      ...
      <div className="project-text mt-4">
        <div className="project-title flex items-center justify-between gap-5">
          ...
          <div className="project-icons flex gap-2 items-center">
            <a
              href="https://github.com/sezergumus/celebchat"
              target="_blank"
              className="github h-fit"
            >
              <svg
            ...
            <a
              href="https://celebchat.sezergumus.dev/"
              target="_blank"
              className="live-project w-fit h-fit"
            >
              <svg
        ...
        <div className="project-stack mt-4">
          <p className="text-white text-[18px] text-yellow font-medium">
            GPT - React - TypeScript - Vite
          </p>
        </div>
        <div className="project-desc mt-4">
          <p className="text-white text-[18px] font-extralight">
            An AI chatbot app for chatting with celebrities or fictional
            characters.
          </p>
        </div>
      </div>
  ...
  return (
    <section className="projects-container mt-[128px]" id="crafts">
      <div className="title-container flex flex-row items-center justify-between gap-3">
        <Reveal>
          <h1
            className={`${archivo.className} title text-yellow text-[64px] mb-32px`}
          >
            Crafts.
          </h1>
        </Reveal>
      ...
      <Reveal>
        <p className="mb-[32px] text-[24px] project-subtitle">
          Great projects are like puzzle pieces they connect together. 🧩
        </p>
      </Reveal>
