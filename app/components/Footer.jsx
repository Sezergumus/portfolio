  ...
  return (
    <section className="footer-container mt-[128px] bg-[#0B0D0D]" id="footer">
      <div className="footer-content flex flex-col">
        <div className="footer-upper py-[64px] border-b-2 border-[#393939] text-center bg-[#0e1010]">
          <div className="mx-auto w-fit">
            <Reveal>
              <h3 className="text-[48px] font-bold footer-upper-text">
                Contact me for <span className="rich-text">amazing</span> works,
                <br />
                <span className="rich-text">stunning</span> visuals.
              </h3>
            </Reveal>
          </div>
        </div>
            ...
            <div className="footer-lower-left flex flex-col items-center">
              <Reveal>
                <a href="mailto:hello@sezergumus.dev">
                  <div className="mail-container flex flex-row items-center justify-center gap-2">
                    ...
                    <span className="text-[48px] max-[600px]:text-[18px] font-bold footer-lower-mail">
                      hello@<b>sezergumus</b>.dev
                    </span>
                  </div>
                </a>
              </Reveal>
              <Reveal>
                <div className="social-icons flex gap-4 mt-4">
                  <a
                    href="https://www.linkedin.com/in/sezergumus/"
                    target="_blank"
                    className="linkedin"
                  >
                    <svg
        ...
        <div className="last-edited text-center text-[16px] pb-4">
          <p className="text-white opacity-60">Last edited on 9/19/23</p>
        </div>
      </div>
    </section>
  );
